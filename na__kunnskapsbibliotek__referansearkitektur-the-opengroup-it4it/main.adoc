...
image:./images/it4it-logo.png[]


:imagesdir@: ../na__felles/images
image:../na__felles/images/i-arbeid.png[width=75, height=75] Første versjon av denne omtalen er fremdeles i arbeid - men kanskje du finner noe nyttig?
...
image:./images/:it-value-chain.png[]
