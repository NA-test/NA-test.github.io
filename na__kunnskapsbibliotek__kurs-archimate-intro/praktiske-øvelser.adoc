...
+
Følg oppskriften under https://nasjonal-arkitektur.github.io/praktiske-tips/#_importer_github_repository, men oppgi https://github.com/nasjonal-arkitektur/archi-kurs-1. 
+
...
+
image:./images/øvingsoppgave2.png[width=1300]
+
