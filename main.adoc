...
. link:.\na__om-plattformen/[Om plattformen]
+
...
. link:.\na__praktiske-tips/[Praktiske tips] 
+
Praktiske tips for å komme i gang og bidra med innhold, forslag og tilbakemeldinger. 


. link:.\na__arkitekturbibliotek/[Nasjonalt arkitekturbibliotek]
+
...
. link:.\na__kunnskapsbibliotek/[Kunnskapsbibliotek]
+
...
. link:.\na__blogg/[Blogger og meningsinnlegg]
+
