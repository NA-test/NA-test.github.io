...
:currentdir: ../na_praktiske-tips_archi
...
image: {currentdir}/images/archi-logo.png[]
...
+
image:../na_praktiske-tips_archi/images/collaboration-plugin.png[width=450, height=450]
+
...
+
image:../na_praktiske-tips_archi/images/archi-collaboration-preferences.png[width=600, height=600]
...
+
image:../na_praktiske-tips_archi/images/preferences-default-figures.png[width=600, height=600]
...
image:../na_praktiske-tips_archi/images/add-remote-model.png[width=550, height=550]

Modell-vinduet i Archi vil vise #difi-nasjonal-arkitektur# som modellnavn:

image:../na_praktiske-tips_archi/images/archi-workspace.png[width=220, height=220]
...
+ 
image:../na_praktiske-tips_archi/images/hidden-git-files.png[width=300, height=300]
