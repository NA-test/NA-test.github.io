...
=== Mappestrukturog inkludering av innhold fra andre mapper
...
Dette opplegget er et kompromiss mellom flere hensyn, herunder enkel oversikt og enkle filreferanser.
...
WARNING: Når en inkluderer innhold fra andre mapper, er det lett å få problemer med visning av bildefiler. Se eget avsnitt om tips for adressering av bildefiler.
...
=== Felles-mappen
Konvensjonen er at alle asciidoc-filer inkluderer maler og annet som ligger i en egen felles-mappe. Her finnes også en mappe med felles bilder og multimediafiler. 
...
== Automatisert konsistenssjekking 
Difi har utviklet løsninger for konsistenssjekking på tvers av biblioteket, blant annet for å sjekke at lenker og include-paths er korrekte. Disse løsningene vil være i kontinuerlig utvikling.
