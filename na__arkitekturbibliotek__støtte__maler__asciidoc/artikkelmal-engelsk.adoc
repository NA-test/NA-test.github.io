...
Here are a couple of image examples: an image:./images/images/smallnew.png[]
example inline image followed by an example block image:./images/

.Tiger block image
image:./images/:images/tiger.png[Tiger image]
