...
image:./images/../na__felles//images/i-arbeid.png[width=75, height=75]  Omstrukturering og tillegg i arbeid
...
image:./images/../na__felles//images/i-arbeid.png[width=75, height=75]I arbeid
