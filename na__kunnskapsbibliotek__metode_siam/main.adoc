...
image:../na__felles/images/i-arbeid.png[width=75, height=75]Uferdig innhold - første versjon er fremdeles i arbeid
...
image:./images/siam-ref-service-now.png[width=700, height=700]Kilde: ServiceNow 
