...
image:./images/eOppslagRefArk.png[alt="missing image, eOppslag Referanse arkitektur"]
...
. link:./sikkerhet/eOppslag_sikkerhetsmodell_overordnet.adoc[Overordnet innføring i sikkerhetsmekanismer for eOppslag]

. link:./sikkerhet/20180629-eoppslag-autorisering-og-delegering.adoc[Modell for autorisering og delegering - eOppslag]
